...
If you are trying out lots of different fonts, you can try using the [\`${PackageScope}dev\` package](https://github.com/expo/google-fonts/tree/master/font-packages/dev#readme).
...
- [\`${PackageScope}dev\` Devlopment Package](https://github.com/expo/google-fonts/tree/master/font-packages/dev)
